  ...
  [
    {
      ...
      image: './birds/europe/Tadorna-ferruginea.jpg',
      audio: './audio/europe/Tadorna-ferruginea.mp3',
    }, {
      id: 5,
      name: 'Мандаринка',
      latin: 'Aix galericulata',
      description: 'Небольшая птица рода лесных уток семейства утиных.',
      image: './birds/europe/Aix-galericulata.jpg',
      audio: './audio/europe/Aix-galericulata.mp3',
    }, {
      id: 6,
      ...
      image: './birds/europe/Netta-rufina.jpg',
      audio: './audio/europe/Netta-rufina.mp3',
    },
  ], [
    {
      id: 7,
      ...
      image: './birds/north-america/Branta-bernicla-nigricans.jpg',
      audio: './audio/north-america/Branta-bernicla-nigricans.mp3',
    }, {
      id: 8,
      name: 'Белошей',
      ...
      image: './birds/north-america/Anser-canagicus.jpg',
      audio: './audio/north-america/Anser-canagicus.mp3',
    }, {
      id: 9,
      name: 'Лебедь-трубач',
      latin: 'Cygnus buccinator',
      description: '',
      image: './birds/north-america/Cygnus-buccinator.jpg',
      audio: './audio/north-america/Cygnus-buccinator.mp3',
    }, {
      id: 10,
      ...
      image: './birds/north-america/Spatula-discors.jpg',
      audio: './audio/north-america/Spatula-discors.mp3',
    }, {
      id: 11,
      name: 'Широконоска',
      ...
      image: './birds/north-america/Spatula-clypeata.jpg',
      audio: './audio/north-america/Spatula-clypeata.mp3',
    }, {
      id: 12,
      ...
      image: './birds/north-america/Mareca-americana.jpg',
      audio: './audio/north-america/Mareca-americana.mp3',
    },
  ], [
    {
      id: 13,
  ...
  ], [
    {
      ...
      image: './birds/asia/Tetraogallus-tibetanus-henrici.jpg',
      audio: './audio/asia/Tetraogallus-tibetanus-henrici.mp3',
    }, {
      id: 26,
      name: 'Немой перепел',
      latin: 'Coturnix japonica',
      description: 'Немой перепел — птица подсемейства куропатковых отряда курообразных.',
      image: './birds/asia/Coturnix-japonica.jpg',
      audio: './audio/asia/Coturnix-japonica.mp3',
    }, {
      id: 27,
      ...
      image: './birds/asia/Alectoris-magna.jpg',
      audio: './audio/asia/Alectoris-magna.mp3',
    }, {
      id: 28,
      name: 'Итагин',
      ...
      image: './birds/asia/Ithaginis-cruentus.jpg',
      audio: './audio/asia/Ithaginis-cruentus.mp3',
    }, {
      id: 29,
      ...
      image: './birds/asia/Lophophorus-lhuysii.jpg',
      audio: './audio/asia/Lophophorus-lhuysii.mp3',
    }, {
      id: 30,
      name: 'Алмазный фазан',
      ...
      image: './birds/asia/Chrysolophus-amherstiae.jpg',
      audio: './audio/asia/Chrysolophus-amherstiae.mp3',
    },
  ], [
    {
      id: 31,
